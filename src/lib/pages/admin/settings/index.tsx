                      ...
                      <HStack display={{ base: 'none', md: 'flex' }}>
                        ...
                        {activeTab === 'Employees' && (
                          <>
                            ...
                            <Box w="120px" textAlign="center">
                              <Text fontSize="13px" color="#333">
                                {item.role === 1 ? 'Employee' : item.role === 4 ? 'IT Admin' : item.role === 5 ? 'Leadership' : item.role === 6 ? 'Compliance Team' : item.role === 7 ? 'Risk and Compliance' : 'Unknown'}
                              </Text>
                            </Box>
                            <Box w="100px" textAlign="center">
                              <Box
                      ...
                      <VStack align="stretch" gap={2} display={{ base: 'flex', md: 'none' }}>
                        ...
                        {activeTab === 'Employees' && (
                          <>
                            ...
                            <Text fontSize="13px" color="#666">
                              Role: {item.role === 1 ? 'Employee' : item.role === 4 ? 'IT Admin' : item.role === 5 ? 'Leadership' : item.role === 6 ? 'Compliance Team' : item.role === 7 ? 'Risk and Compliance' : 'Unknown'}
                            </Text>
                            <HStack gap={2}>
                              <Box
                                as="span"
              ...
              <VStack gap={4} align="stretch">
                ...
                <Box>
                  ...
                  >
                    ...
                    <option value={6}>Compliance Team</option>
                    <option value={7}>Risk and Compliance</option>
                  </select>
                </Box>
                <HStack gap={3} mt={4}>
                  <Button
